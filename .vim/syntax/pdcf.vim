" Vim syntax file
" Language:	Pandoc (superset of Markdown) (dumb LaTeX for speed)
...
"		    spaces
"		-   TeX stuff hacked at by srobertson locally for speed
...
"   Tex Block (begin-end)
syn region pdcCodeBlock start=/\\begin{\z([^}]\+\)}/ end=/\\end{\z1}/ contains=pdcCodeBlock
